...
/obj/item/rig_module/storage
	...
	interface_desc = "A storage container designed to be installed in a RIG suit. Allows a few items to be stored inside"
	...
	var/max_storage_space = DEFAULT_BACKPACK_STORAGE * 0.7 //This is a entire satchel of storage
