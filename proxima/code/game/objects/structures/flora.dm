...
/obj/structure/flora/tree/pine
	name = "pine tree"
	icon = 'proxima/icons/obj/flora/pinetrees.dmi'
	icon_state = "pine_1"
...
/obj/structure/flora/tree/dead/deadtree_0
	icon = 'proxima/icons/obj/flora/deadtrees.dmi'
	icon_state = "tree_1"
...
/obj/structure/flora/tree/pine/old_pinteree
	...
	icon = 'proxima/icons/obj/flora/old_pinetrees.dmi'
...
/obj/structure/flora/tree/green
	...
	pixel_x = -48
	pixel_y = -16
	icon = 'proxima/icons/obj/flora/hdtrees.dmi'
	icon_state = "tree1"
...
/obj/structure/flora/tree/green/pink
	icon = 'proxima/icons/obj/flora/pinktree.dmi'
...
/obj/structure/flora/tree/green/small
	pixel_x = -32
	pixel_y = 0
	icon = 'proxima/icons/obj/flora/hdtreesmall.dmi'
	icon_state = "tree"
	cut_hits = 10
...
/obj/structure/flora/pottedplant
	name = "potted plant"
	icon = 'proxima/icons/obj/flora/plants.dmi'
	icon_state = "plant-26"
...
/obj/structure/flora/ausbushes/jungleflora
	icon = 'proxima/icons/obj/flora/jungleflora.dmi'
	icon_state = "busha"
...
/obj/structure/flora/junglevines/attackby(obj/item/W, mob/living/user)
	if(cut_level !=PLANT_NO_CUT && is_sharp(W))
		...
		user.setClickCooldown(DEFAULT_ATTACK_COOLDOWN)
		to_chat(user, SPAN_WARNING("You cut [cut_hits > 0 ? "some of" : "all of"] \the [src] away with \the [W]."))
		playsound(src, 'proxima/sound/weapons/vegetation_hit.ogg', 25, 1)
		if(cut_hits <= 0)
			qdel(src)
		return
...
/obj/structure/flora/jungleplants/junglebushlarge
	name = "bush"
	icon = 'proxima/icons/obj/flora/junglebushlarge.dmi'
	icon_state = "bush1"
	pixel_x = -16
	pixel_y = -8
...
/obj/structure/flora/jungleplants/glowingflower
	...
	icon = 'proxima/icons/obj/flora/glowingflowers.dmi'
	icon_state = "ywflowers_1"
	light_overlay = TRUE
	l_max_bright = 0.4
	l_inner_range = 1
